...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        for i in range(1,11):
            self.btn_dis[i] = tk.Button(button_frame, text=str(i),height=4,width=4,bg="green")
    ...
    def update(self):
            ...
            if self.ret:
                self.photo = PIL.ImageTk.PhotoImage(image=PIL.Image.fromarray(cv2.resize(self.frame,(500,500))))
